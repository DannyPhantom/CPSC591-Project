...
void SSAOFirstPassFramebuffer::create() {
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F, SceneParameters::getScreenWidth(), SceneParameters::getScreenHeight(), 0, GL_RGBA, GL_FLOAT, NULL);
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F, SceneParameters::getScreenWidth(), SceneParameters::getScreenHeight(), 0, GL_RGB, GL_FLOAT, NULL);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
