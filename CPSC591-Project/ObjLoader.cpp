...
SceneObject *ObjLoader::loadFromFile(const char *fileName) {
	return loadFromFile(std::string(fileName));
}

SceneObject *ObjLoader::loadFromFile(std::string fileName) {
...
SceneObject *ObjLoader::processScene(const aiScene *scene) {
